...
class AlterMasterPegawai extends Migration
{
    ...
    public function up()
    {
        Schema::table('master_pegawai', function($table){
          $table->string('nip_lama', 15)->after('nip');
          $table->string('no_ktp', 20)->after('nip_lama');
          ...
          $table->string('bpjs_kesehatan', 20)->after('kewarganegaraan');
          $table->string('bpjs_ketenagakerjaan', 20)->after('bpjs_kesehatan');
          $table->string('no_rekening', 15)->after('bpjs_ketenagakerjaan');
