<section class="sidebar">
  ...
  <ul class="sidebar-menu">
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        <li><a href="<?php echo e(route('masterpegawai.index')); ?>"><i class="fa fa-circle-o"></i> Lihat Data Pegawai</a></li>
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        <li><a href="<?php echo e(route('masterjabatan.create')); ?>"><i class="fa fa-circle-o"></i> Kelola Data Jabatan</a></li>
      </ul>
    </li>
    <li class="treeview">
      <a href="#">
      ...
      <ul class="treeview-menu">
        <li><a href="<?php echo e(route('masterbahasaasing.create')); ?>"><i class="fa fa-circle-o"></i> Kelola Data Bahasa Asing</a></li>
      </ul>
    </li>
