...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('bootstrap/css/custom9tins.css')); ?>">
    <!-- iCheck -->
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <!-- <div class="login-logo">
        <img src="<?php echo e(asset('images/logo-gmt.png')); ?>" alt="" />
        <a href="../../index2.html">PT. Ganda Mady Pratama</a>
      </div> -->

      <div class="login-logo-custom">
        <div class="logo-custom">
          <img style="float:right;" src="<?php echo e(asset('images/logo-gmt.png')); ?>" alt="" />
        </div>
