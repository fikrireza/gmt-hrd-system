...
// dd($getSPV, $getAnak);
    ...
    public function prosesAll($id)
    {
      ...
      Excel::create('Proses Payrol SPV Periode -'.$getbatch->tanggal_proses.' s-d '.$getbatch->tanggal_proses_akhir, function($excel) use($getkomponengaji,$getbatch,$hasilQuery) {
          $excel->sheet('All Payroll', function($sheet) use($getkomponengaji,$getbatch,$hasilQuery) {
