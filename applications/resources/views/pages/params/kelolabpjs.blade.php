          ...
          <div class="modal-body">
            <div class="form-group">
              ...
              <div class="col-sm-9">
                ...
                <select name="id_client_edit" class="form-control select2" style="width: 100%;" required="true" id="id_client_edit">
            ...
            <div class="form-group ">
              ...
              <select class="form-control" name="tipe_bpjs_edit" id="tipe_bpjs_edit">
                ...
                <option value="Kesehatan" id="flag_kesehatan_edit">Kesehatan</option>
                <option value="Ketenagakerjaan" id="flag_ketenagakerjaan_edit">Ketenagakerjaan</option>
                <option value="Pensiun" id="flag_pensiun_edit">Pensiun</option>
              </select>
              </div>
            </div>
            <div class="form-group ">
